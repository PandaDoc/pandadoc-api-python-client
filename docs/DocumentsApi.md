...
[**document_status_change**](DocumentsApi.md#document_status_change) | **PATCH** /public/v1/documents/{id}/status | Document status change
...
# **document_create**
> DocumentCreateResponse document_create(document_create_request)
...
with pandadoc_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create document
        api_response = api_instance.document_create(document_create_request)
        pprint(api_response)
    except pandadoc_client.ApiException as e:
    ...
    try:
        # Create document
        api_response = api_instance.document_create(
...
with pandadoc_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List documents
        api_response = api_instance.document_list(
...
> document_status_change(id, document_status_change_request)
...
with pandadoc_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Document status change
        api_instance.document_status_change(id, document_status_change_request)
    except pandadoc_client.ApiException as e:
        print("Exception when calling DocumentsApi->document_status_change: %s\n" % e)
```
