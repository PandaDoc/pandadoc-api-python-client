...
def lazy_import():
    ...
    globals()['DocumentUpdateRequestRecipients'] = DocumentUpdateRequestRecipients
    globals()['PricingTableRequest'] = PricingTableRequest


class DocumentUpdateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): You can pass arbitrary data in the key-value format to associate custom information with a document. This information is returned in any API requests for the document details by id. If metadata exists in a document then the value will be updated. Otherwise, metadata will be added to the document.. [optional]  # noqa: E501
