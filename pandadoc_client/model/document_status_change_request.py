...
class DocumentStatusChangeRequest(ModelNormal):
    ...
    attribute_map = {
        ...
        'note': 'note',  # noqa: E501
        'notify_recipients': 'notify_recipients',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, status, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            note (str): Provide “private notes” regarding the manual status change.. [optional]  # noqa: E501
            notify_recipients (bool): Send a notification email about the status change to all recipients.. [optional]  # noqa: E501
        """
