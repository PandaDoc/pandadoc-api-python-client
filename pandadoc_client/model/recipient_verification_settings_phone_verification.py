...
class RecipientVerificationSettingsPhoneVerification(ModelNormal):
    ...
    validations = {
        ('phone_number',): {
            'regex': {
                'pattern': r'^\+[1-9]\d{0,4}\d{2,14}$',  # noqa: E501
            },
        },
    }
    ...
    def _from_openapi_data(cls, phone_number, *args, **kwargs):  # noqa: E501
        """RecipientVerificationSettingsPhoneVerification - a model defined in OpenAPI
