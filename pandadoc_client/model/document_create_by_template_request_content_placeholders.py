...
def lazy_import():
    ...
    globals()['DocumentCreateByTemplateRequestContentLibraryItems'] = DocumentCreateByTemplateRequestContentLibraryItems


class DocumentCreateByTemplateRequestContentPlaceholders(ModelNormal):
