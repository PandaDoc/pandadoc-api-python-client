...
class LinkedObjectCreateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, provider, entity_type, entity_id, *args, **kwargs):  # noqa: E501
        """LinkedObjectCreateRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, provider, entity_type, entity_id, *args, **kwargs):  # noqa: E501
        """LinkedObjectCreateRequest - a model defined in OpenAPI
