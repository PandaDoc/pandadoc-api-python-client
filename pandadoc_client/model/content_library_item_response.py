...
class ContentLibraryItemResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'content_placeholders': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ContentLibraryItemResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            content_placeholders ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): [optional]  # noqa: E501
