...
class UploadSectionByPdfRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, url, recipients, *args, **kwargs):  # noqa: E501
        """UploadSectionByPdfRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            fields ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): If you are upload a section from a PDF with field tags, you can pass a list of the fields you'd like to pre-fill in the document. If you are upload a section from a PDF with form fields, list all the fields and provide the `role` parameter so that the fields are assigned to document recipients. You can provide empty value for the field so that it's not pre-filled: \"value\": \"\". . [optional]  # noqa: E501
        """
