...
class WebhookSubscriptionCreateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, url, triggers, *args, **kwargs):  # noqa: E501
        """WebhookSubscriptionCreateRequest - a model defined in OpenAPI

        Args:
            name (str):
            url (str):
            triggers ([WebhookSubscriptionTriggerEnum], none_type):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, url, triggers, *args, **kwargs):  # noqa: E501
        """WebhookSubscriptionCreateRequest - a model defined in OpenAPI
