...
class QuotesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.quote_update_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/public/v1/documents/{document_id}/quotes/{quote_id}',
                'operation_id': 'quote_update',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def quote_update(
        ...
        **kwargs
        ...
        """Quote update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.quote_update(document_id, quote_id, quote_update_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['quote_id'] = \
            quote_id
        kwargs['quote_update_request'] = \
            quote_update_request
        return self.quote_update_endpoint.call_with_http_info(**kwargs)
