...
class FoldersAPIApi(object):
    ...
    def create_document_folder(
        ...
        **kwargs
        ...
        >>> thread = api.create_document_folder(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            documents_folder_create_request (DocumentsFolderCreateRequest): [optional]
    ...
    def create_template_folder(
        ...
        **kwargs
        ...
        >>> thread = api.create_template_folder(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            templates_folder_create_request (TemplatesFolderCreateRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def rename_document_folder(
        ...
        **kwargs
        ...
        >>> thread = api.rename_document_folder(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            documents_folder_rename_request (DocumentsFolderRenameRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def rename_template_folder(
        ...
        **kwargs
        ...
        >>> thread = api.rename_template_folder(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            templates_folder_rename_request (TemplatesFolderRenameRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
